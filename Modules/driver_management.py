...
class DriverManager:
    ...
    def __init__(self, csv_file: str = None):
        # Default to data/driver.csv if no file specified
        if csv_file is None:
            self.csv_file = os.path.join("data", "driver.csv")
        else:
    ...
    def load_drivers(self):
        ...
        try:
            ...
            if not os.path.exists(self.csv_file):
                ...
                print(f"Please ensure the driver.csv file exists in the data folder.")
                return
            ...
            print(f"Successfully loaded {len(self.all_drivers)} drivers from {self.csv_file}")
